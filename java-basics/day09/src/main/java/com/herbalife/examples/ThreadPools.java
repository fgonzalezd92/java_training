...
//        ExecutorService executorService = Executors.newCachedThreadPool();
        ExecutorService executorService = ForkJoinPool.commonPool(); //The threads terminate when main terminates
        Runnable codingTask = () -> {
            while(true){
                System.out.println("Coding and committing chances..." + Thread.currentThread().getName());
